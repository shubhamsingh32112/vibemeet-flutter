...
const steps = [
  {
    ...
    step: "01",
    title: "Sign In",
    description: "One-tap Fast Login – no account or password needed. Get started in seconds.",
    color: "bg-primary",
  },
  {
    icon: Search,
    step: "02",
    title: "Discover",
    description: "Browse creators and find people who match your vibe.",
    color: "bg-secondary",
  },
  {
    icon: Heart,
    step: "03",
    title: "Chat",
    description: "Start with text chat, then move to video when you're ready.",
    color: "bg-primary",
  },
  {
    icon: Video,
    step: "04",
    title: "Connect",
    description: "Enjoy private 1v1 video calls. Coins power your calls – new users get free coins.",
    color: "bg-secondary",
  },
];
